...
%\begin{figure}[h]
%\centering
%\includegraphics[scale=0.4]{WilletQHEMeasurement.png}
%\caption{Willet and colleagues' measurement of the quantum Hall effect \cite{will:qhm}. Note the extensive %number of quantum Hall states.}
%\label{detailedQHE}
%\end{figure}
...
Through our examination of the quantum Hall effect, we have seen a physical realization of a topologically-ordered phase of matter.  For these systems, the tunable parameter is the electron density, the topological invariant is related to the filling factor, and the phases are separated by discontinuous changes in the filling factor that we observe as changes in the quantized conductance. These phases demonstrate ground state degeneracy and entanglement, and show fractionalized excitations that are the hallmark of topological order.
